    ...
    <div class="row">
                            ...
                            <tbody>
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('admin.master.jobs.experience.delete', ['id' => $item->id]) }}"
                                    ...
                                    <div class="modal fade" tabindex="-1" id="kt_modal_{{ $loop->iteration }}">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form action="{{ route('admin.master.jobs.experience.update') }}" method="POST"
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <h1>Create Data</h1>
                    <form action="{{ route('admin.master.jobs.experience.add') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="row d-flex">
