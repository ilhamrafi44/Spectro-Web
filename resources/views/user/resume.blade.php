                                    ...
                                    <td>
                                        ...
                                        @else
                                            <a href="/storage/file/user/resume/{{ $data->cv_file }}"
                                                ...
                                                <a href="{{ route('user.resume.reset', ['column' => 'cv_file']) }}" class="btn btn-white text-spectro btn-sm">x</a>
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <a href="/storage/file/user/resume/{{ $data->language_certificate_file }}"
                                                ...
                                                <a href="{{ route('user.resume.reset', ['column' => 'language_certificate_file']) }}" class="btn btn-white text-spectro btn-sm">x</a>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <a href="/storage/file/user/resume/{{ $data->ssw_certificate_file }}"
                                                class="btn btn-sm btn-light">Lihat</a>
                                                <a href="{{ route('user.resume.reset', ['column' => 'ssw_certificate_file']) }}" class="btn btn-white text-spectro btn-sm">x</a>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <a href="/storage/file/user/resume/{{ $data->other_certificate_file }}"
                                                class="btn btn-sm btn-light">Lihat</a>
                                                <a href="{{ route('user.resume.reset', ['column' => 'other_certificate_file']) }}" class="btn btn-white text-spectro btn-sm">x</a>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <a href="/storage/file/user/resume/{{ $data->driving_license_file }}"
                                                class="btn btn-sm btn-light">Lihat</a>
                                                <a href="{{ route('user.resume.reset', ['column' => 'driving_license_file']) }}" class="btn btn-white text-spectro btn-sm">x</a>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <a href="/storage/file/user/resume/{{ $data->pasport_file }}"
                                                class="btn btn-sm btn-light">Lihat</a>
                                                <a href="{{ route('user.resume.reset', ['column' => 'pasport_file']) }}" class="btn btn-white text-spectro btn-sm">x</a>
