    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            ...
            <div id="kt_app_header" class="app-header">
                ...
                <div class="app-header-primary shadow-lg" data-kt-sticky="true" data-kt-sticky-name="app-header-primary-sticky" data-kt-sticky-offset="{default: 'false', lg: '300px'}">
                    ...
                    <div class="app-container container-xxl d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex flex-grow-1 flex-lg-grow-0">
                            ...
                            <div class="d-flex align-items-center" id="kt_app_header_logo_wrapper">
                                <!--begin::Header toggle-->
                                <button class="d-lg-none btn btn-icon btn-color-danger btn-active-color-dark ms-n4 me-sm-2" id="kt_app_header_menu_toggle">
                                ...
                                <a href="../dist/index.html" class="d-flex align-items-center mb-1 mb-lg-0 pt-lg-1">
                                    <img alt="Logo" src="{{ asset('assets/media/spectro-small.png') }}" class="d-block d-sm-none" height="30px" />
                                    <img alt="Logo" src="{{ asset('assets/media/spectro.png') }}" class="d-none d-sm-block" height="40px"/>
                                </a>
                                <!--end::Logo-->
                            </div>
                            <!--end::Logo wrapper-->
                        ...
                        <div class="app-navbar">
                            ...
                            <div class="app-navbar-item ms-1">
                                <!--begin::Menu- wrapper-->
                                <div class="btn btn-icon btn-color-danger btn-active-color-dark" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" id="kt_menu_notifications">
                                    ...
                                    <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('assets/media/misc/menu-header-bg.jpg')">
                                        ...
                                        <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9">
                                            <li class="nav-item">
                                                <a class="nav-link text-white opacity-75 show active opacity-state-100 pb-4" data-bs-toggle="tab" href="#kt_topbar_notifications_1">Alerts</a>
                                            </li>
                                            <li class="nav-item">
                            ...
                            <div class="app-navbar-item ms-1">
                                <!--begin::Menu wrapper-->
                                <div class="btn btn-icon btn-color-danger btn-active-color-dark" id="kt_drawer_chat_toggle">
