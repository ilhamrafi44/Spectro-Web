                            ...
                            <div class="card-body">
                                <div class="row d-flex flex-columns align-items-center">
                                    ...
                                    <div class="col-auto ms-auto">
                                        <a href="{{ route('detai.employer', ['id' => $item->following->id]) }}" class="btn btn-light m-1" target="_blank" >Lihat</a>
                                        <a href="{{ route('following.saved.destroy', ['id' => $item->id]) }}" class="btn btn-primary m-1">Unfollow</a>
                                    </div>
                                </div>
                            </div>
                        </div>
