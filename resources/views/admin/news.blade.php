                            ...
                            <div class="col-md-5">
                                <div class="mb-5 ">
                                    <input type="text" name="name" value="{{ request()->get('name') }}"
                                        class="form-control" placeholder="Enter your keyword title/message..">
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="mb-5 ">
                            ...
                            <tbody>
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td><a href="{{ route('admin.news.delete', ['id' => $item->id]) }}"
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="mb-5">
                                                                    <label for="exampleFormControlInput1"
                                                                        class="required form-label">Data
                                                                        Title</label>
                                                                ...
                                                                <div class="mb-5">
                                                                    <label for="exampleFormControlInput1"
                                                                        class="required form-label">Data
                                                                        Message</label>
                                                                        <textarea name="message" id="" cols="30" rows="10" class="form-control form-control-solid">{{ $item->message }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <form action="{{ route('admin.news.add') }}" method="POST"
                        ...
                        <div class="row d-flex">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="mb-5">
                                    <label for="exampleFormControlInput1" class="required form-label">Title</label>
                                    <textarea name="message" id="" cols="30" rows="10" class="form-control form-control-solid"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-5">
                                    <button class="btn btn-primary btn-md" type="submit">Create Data</button>
                                </div>
                            </div>
                        </div>
                    </form>
