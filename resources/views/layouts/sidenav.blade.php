    ...
    <section class="sidebar" id="sidebar-scroll">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <a class="waves-effect waves-dark" href="index.html">
                    <i class="icon-book-open"></i><span> Resume Saya</span>
                </a>
                <a class="waves-effect waves-dark" href="index.html">
                    <i class="icon-briefcase"></i><span> Cari Kerja</span>
                </a>
            </li>
            {{-- <li class="nav-level">--- Components</li>
            <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-briefcase"></i><span>
                        UI Elements</span><i class="icon-arrow-down"></i></a>
                <ul class="treeview-menu">
                    ...
                    <li><a class="waves-effect waves-dark" href="bootstrap-ui.html"><i class="icon-arrow-right"></i>
                            Grid system</a></li>
                    <li><a class="waves-effect waves-dark" href="box-shadow.html"><i class="icon-arrow-right"></i> Box
                            Shadow</a></li>
            ...
            <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-chart"></i><span>
                        Menu Tambahan</span><span class="label label-success menu-caption">New</span><i
            ...
            <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-book-open"></i><span>
                        Forms</span><i class="icon-arrow-down"></i></a>
                <ul class="treeview-menu">
            ...
            <li class="active treeview"><a class="waves-effect waves-dark" href="#!"><i
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="active"><a class="waves-effect waves-dark" href="sample-page.html"><i
